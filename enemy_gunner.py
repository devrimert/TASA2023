...
class EnemyGunner(object):
    ...
    animation_number = 0
    counter = 0
    current = images.enemy_gunner_list[animation_number]
    ...
    def animation(self):
        ...
        if self.counter == 2:
            ...
            if self.next_0:
                self.current = images.enemy_gunner_list[0]
                self.next_0 = False
                self.next_1 = True
            elif self.next_1:
                self.current = images.enemy_gunner_list[1]
                self.next_1 = False
                self.next_0 = True
